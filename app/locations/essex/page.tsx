                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      280 South Harrison Street, Suite 1F
                    </p>
                    <p className="text-white">East Orange, NJ 07018</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-xl overflow-hidden">
              ...
              <div className="relative h-[400px] w-full">
                <Image
                  src="https://images.unsplash.com/photo-1551814818-348e1a614617?q=80&w=2069&auto=format&fit=crop"
                  alt="Essex County Map"
                  fill
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-xl overflow-hidden">
              <div className="p-6 border-b border-gray-700">
                <h2 className="text-xl font-bold text-white">
                  About Our Essex County Cleaning Services
                </h2>
              </div>
              <div className="p-6">
                <p className="text-gray-300 mb-4 leading-relaxed">
                  Our Essex County location provides professional cleaning
                  services for both residential and commercial clients
                  throughout the area. We specialize in cleaning services for
                  Newark, Montclair, and all surrounding communities.
                </p>
                <p className="text-gray-300 mb-6 leading-relaxed">
                  From regular maintenance to specialized deep cleaning, our
                  experienced team delivers exceptional results every time.
