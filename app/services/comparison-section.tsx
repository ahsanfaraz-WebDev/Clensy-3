...
import { Check, X, Zap, Shield, Sparkles, Clock, Leaf, Brain, Cpu, Users } from "lucide-react"
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Experience the future of cleaning with our smart, AI-enhanced services. See how we compare to traditional
            cleaning services.
          </p>
          ...
          >
            <div className="backdrop-blur-md bg-black/90 border border-black/20 rounded-2xl p-6 h-full shadow-lg relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/70 text-center">Smart Cleaning Service</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="backdrop-blur-md bg-gray-200 border border-gray-300 rounded-2xl p-6 h-full shadow-lg">
              <div className="flex items-center justify-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-700">Traditional</h3>
              </div>
              <p className="text-gray-600 text-center">Conventional Cleaning Service</p>
            </div>
          </motion.div>
            ...
            <React.Fragment key={index}>
              ...
              >
                <div className="p-4 w-full">
                  <h4 className="text-lg font-medium text-black">{item.feature}</h4>
              ...
              >
                <div
                  className={cn(
                    ...
                    item.clensy ? "bg-black border-black/20" : "bg-transparent border-black/5",
                  )}
                >
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-white blur-xl"></div>
                  <motion.div
              ...
              >
                <div
                  className={cn(
                    ...
                    item.traditional ? "bg-gray-200 border-gray-300" : "bg-transparent border-gray-200",
                  )}
                >
        ...
        >
          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Experience the future of cleaning today with Clensy's smart services.
          </p>
