    ...
    <div className="min-h-screen overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Professional cleaning services tailored to your needs. Choose the service that best fits your
              requirements.
            </p>
          </motion.div>
        </div>
      ...
      <section className="py-12 bg-white relative z-10">
        <div className="container mx-auto px-4 md:px-6">
          <Tabs defaultValue="standard-cleaning" onValueChange={setSelectedService} className="w-full">
              ...
              {["standard-cleaning", "deep-cleaning", "move-in-out", "office-cleaning"].map((service) => (
                <TabsContent key={service} value={service} className="mt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                      <Image
                        src={serviceImages[service as keyof typeof serviceImages] || "/placeholder.svg"}
                        alt={service.replace("-", " ")}
                        width={600}
                        height={400}
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.8, ease: "easeOut" }}
                    >
                      <h2 className="text-3xl font-bold mb-6 capitalize">{service.replace(/-/g, " ")}</h2>
                      ...
                      >
                        {serviceDetails[service as keyof typeof serviceDetails].map((detail, index) => (
                          <motion.div key={index} variants={serviceItem} className="flex items-start gap-3">
                      ...
                      <Link href="/pricing" className="brand-button inline-flex items-center">
                        Book This Service
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to experience the Clensy difference?</h2>
            <p className="text-gray-600 mb-8">Book your cleaning service today and enjoy a spotless home or office.</p>
            <Link href="/pricing" className="brand-button inline-flex items-center">
              Get Started
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
